...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([[587], {
    3587: (e, t, n) => {
        ...
        let y = u.default.forwardRef(function(e, t) {
            let n, r;
            let {href: l, as: y, children: g, prefetch: b=null, passHref: m, replace: P, shallow: _, scroll: v, onClick: E, onMouseEnter: j, onTouchStart: O, legacyBehavior: M=!1, ...C} = e;
            n = g,
            ...
            let q = {
                ...
                onClick(e) {
                    ...
                    k && !e.defaultPrevented && function(e, t, n, r, o, l, a) {
            ...
            return (0,
            s.isAbsoluteUrl)(S) ? q.href = S : M && !m && ("a" !== r.type || "href"in r.props) || (q.href = (0,
            d.addBasePath)(S)),
            M ? u.default.cloneElement(r, q) : (0,
            o.jsx)("a", {
                ...C,
                ...q,
                children: n
    ...
    7150: (e, t, n) => {
        ...
        function u(e) {
            ...
            e.host ? i = t + e.host : n && (i = t + (~n.indexOf(":") ? "[" + n + "]" : n),
            e.port && (i += ":" + e.port)),
            f && "object" == typeof f && (f = String(r.urlQueryToSearchParams(f)));
            let c = e.search || f && "?" + f || "";
            return u && !u.endsWith(":") && (u += ":"),
            e.slashes || (!u || o.test(u)) && !1 !== i ? (i = "//" + (i || ""),
            l && "/" !== l[0] && (l = "/" + l)) : i || (i = ""),
            a && "#" !== a[0] && (a = "#" + a),
            c && "?" !== c[0] && (c = "?" + c),
            "" + u + i + (l = l.replace(/[?#]/g, encodeURIComponent)) + (c = c.replace("#", "%23")) + a
        }
